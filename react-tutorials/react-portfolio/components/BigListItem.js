  ...
  return (
    <div id="PortfolioItemGroup" class="group">
      <Link href={href}>
        <div
          id="PortfolioItem"
          className="py-2 mx-4 group-hover:bg-gray-700 rounded-md max-w-3xl"
        >
          <div
          ...
          >
            <div id="containerImageTitle" className="flex items-center gap-6">
              ...
              <div className=" text-white text-ellipsis whitespace-nowrap overflow-hidden max-w-xl">
                <h2 className="w-44 sm:w-64 md:w-64 lg:w-95 xl:w-100 text-ellipsis whitespace-nowrap overflow-hidden inline-block text-base">
                  {title}
                </h2>
