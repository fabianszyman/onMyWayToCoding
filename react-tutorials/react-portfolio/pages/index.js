...
import btuLogoImage from '../public/btuLogo-min.webp'
import googleLogo from '../public/googleLogo-min.webp'
...
export default function Home() {
  return (
    <div>
      ...
      <main className='font-gothamLight text-white scroll-smooth md:px-24 lg:px-40 2xl:px-48 bg-black '>

      


      <div id="heroHeader" className="w-full max-w-128 h-1/3 max-h-96 bg-darkgray text-white overflow-hidden relative" >
      ...
      <nav className="fixed bottom-0 inset-x-0 flex justify-between text-xs text-white-100 bg-black font-gothamBold md:px-24 lg:px-40  2xl:px-64">
