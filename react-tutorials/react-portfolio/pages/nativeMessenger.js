...
export default function Home() {
  let pageName = "Native Messenger (iOS & Android)";
  return (
    <div>
      <Head>
      ...
      <main className="text-white font-gothamBold bg-black h-screen ">
        ...
        <div className=" bg-black pt-16 px-4">
          ...
          <h1 className=" text-xl ">Native Messenger (iOS & Android)</h1>
          ...
          <div className="text-xl pt-6">Overview</div>
          ...
          <div className="text-xl pt-6">Goal</div>
          <div className="font-gothamLight text-lg pt-1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
            mollitia, molestiae quas vel sint commodi repudiandae consequuntur
            voluptatum laborum numquam blanditiis harum quisquam eius sed odit
          ...
          <div className="text-xl pt-6">Results</div>
          <div className="font-gothamLight text-lg pt-1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
            mollitia, molestiae quas vel sint commodi repudiandae consequuntur
            voluptatum laborum numquam blanditiis harum quisquam eius sed odit
          ...
          <div className="text-xl pt-6">Process</div>
          <div className="font-gothamLight text-lg pt-1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
            mollitia, molestiae quas vel sint commodi repudiandae consequuntur
            voluptatum laborum numquam blanditiis harum quisquam eius sed odit
          ...
          <div className="text-xl pt-6">Responsibilities</div>
          <div className="font-gothamLight text-lg pt-1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime
            mollitia, molestiae quas vel sint commodi repudiandae consequuntur
            voluptatum laborum numquam blanditiis harum quisquam eius sed odit
          ...
          <div className="text-xl pt-6">Team</div>
