                ...
                <div class='group'>
                    <div className='w-full font-gothamLight text-xs'>
                        <div className='flex items-center gap-1 text-gray-400 py-2 group-hover:bg-gray-700 rounded-md max-w-lg relative '>
                            ...
                            <div className='w-6/12 py-4 px-3 text-left group-hover:text-white '>
                                Minimalistic Landing Page
                            </div>
                            <div className=' w-2/12 h-12 py-4 text-right group-hover:text-white '>
                                HTML|CSS
                            </div>
                            <div className='w-2/12 h-12 py-4 px-2 text-right'>
                                12 hours
                            </div>
                        </div>
                    </div>
